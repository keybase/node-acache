...
(function() {
  var ACache, LRU, LockTable, crypto, hash, iced, __iced_k, __iced_k_noop,
    __slice = [].slice;
  ...
  ACache = (function() {
    ...
    ACache.prototype.uncache = function(_arg) {
      var key_by;
      key_by = _arg.key_by;
      return this._lru.remove(this._cache_key(key_by));
    };

    ACache.prototype.get_lru = function(_arg) {
      var key_by;
      key_by = _arg.key_by;
      return this._lru.remove(this._cache_key(key_by));
    };

    ACache.prototype._cache_key = function(o) {
      return hash(o, {
        encoding: 'base64'
      }).slice(0, 14);
    };
